 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.examples.statemachines.interpretedstatemachines.statemachines.almostuml.impl.TriggerImpl#getEvent <em>Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriggerImpl extends NamedElementImpl implements Trigger {
	...
	protected EClass eStaticClass() {
		return AlmostumlPackage.Literals.TRIGGER;
	}
		...
		if (event != null && event.eIsProxy()) {
			...
			if (event != oldEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AlmostumlPackage.TRIGGER__EVENT, oldEvent, event));
			}
		}
		return event;
	}
	...
	public void setEvent(Event newEvent) {
		...
		event = newEvent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlmostumlPackage.TRIGGER__EVENT, oldEvent, event));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlmostumlPackage.TRIGGER__EVENT:
